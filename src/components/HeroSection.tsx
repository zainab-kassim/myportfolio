...
export default function HeroSection() {
  return (
    <>
      ...
      <div className='flex flex-col sm:px-14 px-5  justify-center items-center pt-5 mt-24 sm:mt-36'>
        ...
        <ScrollReveal animation='animate-expand-horizontally'>
          <div className='flex justify-items-center mt-8 gap-3 relative mb-14  '>
            <a href="https://x.com/TemiDevtips" target='_blank' className='cursor-pointer'><Image height={70} width={70} className='bg-[#292929]  sm:w-14 sm:h-12 w-12 h-10 rounded-md px-4 py-3 -rotate-3 relative top-1' alt='twitter logo' src='https://img.icons8.com/?size=100&id=A4DsujzAX4rw&format=png&color=ffffff' /></a>
            <a href="https://github.com/zainab-kassim" target='_blank' className='cursor-pointer'><Image height={70} width={70} className='bg-[#292929] sm:w-14 sm:h-12 w-12 h-10 rounded-md px-4 py-3 -rotate-2' alt='githublogo' src={githublogo} /></a>
            <a href="https://www.linkedin.com/in/zainab-kassim/" target='_blank' className='cursor-pointer'><Image height={70} width={70} className='bg-[#292929] sm:w-14 sm:h-12 w-12 h-10 rounded-md px-4 py-3' alt='linkedinlogo' src='https://img.icons8.com/?size=100&id=2EqeH19eMd3a&format=png&color=ffffff' /></a>
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=kassimzainab11@gmail.com" target="_blank" rel="noopener noreferrer"><Image height={70} width={70} className='bg-[#292929] sm:w-14 sm:h-12 w-12 h-10 rounded-md px-4 py-3 rotate-2' alt='maillogo' src='https://img.icons8.com/?size=100&id=Y2GfpkgYNp42&format=png&color=ffffff' /></a>
            <a href="https://www.instagram.com/zainab_temi_/" target='_blank' className='cursor-pointer'><Image height={80} width={80} className='bg-[#292929] sm:w-14 sm:h-12 w-12 h-10 rounded-md px-4 py-3 rotate-3 relative top-1' alt='instagram logo' src='https://img.icons8.com/?size=100&id=32320&format=png&color=FFFFFF' /></a>
          </div>
        </ScrollReveal>
