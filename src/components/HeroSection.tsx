  ...
  return (
    <>
      <div className='sm:px-14 px-5 sticky top-8 z-20 '>
        <div className='flex  mx-auto max-w-sm sm:max-w-3xl sm:justify-between  justify-items-center   sm:px-5 items-center bg-[#121212]/67  border-[0.5px] inset-shadow-sm shadow-xl/30 backdrop-blur-3xl  border-[#8f8f8f4c] py-2 rounded-full '>
      ...
      <div className='flex flex-col sm:px-14 px-5  justify-center items-center pt-5 mt-20 sm:mt-36'>
        ...
        <ScrollReveal animation='animate-expand-horizontally' duration='800'>
          <div className='flex justify-items-center mt-8 gap-3 relative mb-14  '>
            <a href="https://x.com/TemiDevtips" target='_blank' className='cursor-pointer'><Image height={70} width={70} className='bg-[#292929]  sm:w-14 sm:h-12 w-11 h-9 rounded-md px-4 py-3 -rotate-3 relative top-1' alt='twitter logo' src='https://img.icons8.com/?size=100&id=A4DsujzAX4rw&format=png&color=ffffff' /></a>
