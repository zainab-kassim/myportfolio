  ...
  return (
    <>
      <div className='sm:px-14 px-5 sticky top-8 z-20 '>
        <div className='flex  mx-auto max-w-[90%] sm:max-w-3xl sm:justify-between  justify-items-center px-3   sm:px-5 items-center bg-[#121212]/67  border-[0.5px] inset-shadow-sm shadow-xl/30 backdrop-blur-3xl  border-[#8f8f8f4c] py-2 rounded-full '>
          ...
          <div className='flex lg:gap-12 md:gap-9 gap-6 mx-auto  text-white tracking-wide items-center lg:text-[13px] text-sm'>
