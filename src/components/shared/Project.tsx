    ...
    return (
        <div className='my-40 '>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-x-10 gap-y-14 mt-16'>
                ...
                <div className='border-[1px] md:h-[680px] h-[690px]  border-[#605c5c97] pt-6 pb-10 rounded-xl'>
                    <Image width={900} height={900} className='rounded-t-xl max-w-full' alt='project1' src={proj1} />
                    <div className='pt-8 px-5'>
                        ...
                        <div className='flex flex-wrap gap-4 items-center max-w-xl my-12'>
                            <div className='flex items-center h-10 justify-center gap-2 px-4 py-2 w-auto rounded-lg border-[0.5px] border-[#292828] bg-[#191919]'>
                ...
                <div className='border-[1px]  md:h-[680px] h-[690px] border-[#605c5c97]  pt-6 pb-10  rounded-xl'>
                    <Image width={900} height={900} className='rounded-t-xl' alt='project2' src={proj2} />
                    <div className='pt-8 px-5'>
                ...
                <div className='border-[1px] md:h-[680px] h-[690px]  border-[#605c5c97] pt-6 pb-10 rounded-xl'>
                    <Image width={900} height={900} className='rounded-t-xl' alt='project2' src={proj3} />
                    <div className='pt-8 px-5'>
